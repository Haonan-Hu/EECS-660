...
which means your .py file and seldCheck.py and test_files folder are at the same level.
...
def grading(name):
    ...
    score = 0
    test_files = ["output_10.txt", "output_20.txt", "output_500.txt", "output_1000.txt"]
    label_files = ["sm_output_10.txt", "sm_output_20.txt", "sm_output_500.txt", "sm_output_1000.txt"]
